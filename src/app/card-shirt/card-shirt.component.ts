...
@Component({
    ...
    standalone: true,
    imports: [NgClass, NgOptimizedImage, GetRarityImagePipe, GetFrameImagePipe, GetBannerImagePipe, GetProvisionBannerImagePipe, GetProvisionFontSizePipe, GetTypeImagePipe, GetCardbackImagePipe, GetCardHeightPipe]
})
